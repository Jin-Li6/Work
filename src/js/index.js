...
//                 var listdata = data.phone; //列表数据				         
//                 if (listdata.length > 0) { //项目列表
//                     var listInfo = "";
//                     $.each(listdata, function () {

//                         //         <li class="brick-item brick-item-m brick-item-m-2">
//                         //         <a href=""><div class="figure figure-img"><img src="https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/0099822e42b4428cb25c4cdebc6ca53d.jpg?thumb=1&w=250&h=250&f=webp&q=90" alt=""></div>
